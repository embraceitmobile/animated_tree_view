...
// }
//
// class SimpleIndexedNode extends IndexedListenableNode<SimpleIndexedNode> {
//   /// A [SimpleIndexedNode] that can be used with the [IndexedTreeView].
//   ///
//   /// To use your own custom data with [IndexedTreeView], extend the [IndexedListenableNode]
//   /// like this:
//   /// ```dart
