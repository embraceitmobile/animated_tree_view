...
abstract base class _TreeView<Data, Tree extends ITreeNode<Data>>
  ...
  /// An optional callback that can be used to handle any action when an item is
  /// double tapped or double clicked
  final ValueSetter<Tree>? onItemDoubleTap;

  /// An optional callback that can be used to handle any action when an item is
  /// secondary tapped or secondary clicked
  final ValueSetter<Tree>? onItemSecondaryTap;

  /// An optional callback that can be used to handle any action when an item is
  /// secondary tapped down or secondary clicked down
  final Function(Tree, TapDownDetails)? onItemSecondaryTapDown;

  /// An optional callback that can be used to handle any action when an item is
  /// secondary tapped up or secondary clicked up
...
mixin _TreeViewState<Data, Tree extends ITreeNode<Data>,
  ...
  Widget _insertedItemBuilder(
    ...
    return ExpandableNodeItem.insertedNode<Data, Tree>(
      ...
      onItemSecondaryTap: widget.onItemSecondaryTap,
      onItemSecondaryTapDown: widget.onItemSecondaryTapDown,
...
final class TreeView<Data, Tree extends ITreeNode<Data>>
  ...
  const TreeView._({
    ...
    super.onItemTap,
    super.onItemDoubleTap,
    super.onItemSecondaryTap,
    super.onItemSecondaryTapDown,
    super.onItemSecondaryTapUp,
  ...
  static TreeView<Data, TreeNode<Data>> simple<Data>({
    ...
    ValueSetter<TreeNode<Data>>? onItemDoubleTap,
    ValueSetter<TreeNode<Data>>? onItemSecondaryTap,
    Function(TreeNode<Data>, TapDownDetails)? onItemSecondaryTapDown,
    Function(TreeNode<Data>, TapUpDetails)? onItemSecondaryTapUp,
    ValueSetter<TreeNode<Data>>? onItemLongPress,
    bool? primary,
  ...
  static TreeView<Data, IndexedTreeNode<Data>> indexed<Data>({
    ...
    ValueSetter<IndexedTreeNode<Data>>? onItemDoubleTap,
    ValueSetter<IndexedTreeNode<Data>>? onItemSecondaryTap,
    Function(IndexedTreeNode<Data>, TapDownDetails)? onItemSecondaryTapDown,
    Function(IndexedTreeNode<Data>, TapUpDetails)? onItemSecondaryTapUp,
    ValueSetter<IndexedTreeNode<Data>>? onItemLongPress,
    bool? primary,
    ScrollPhysics? physics,
    EdgeInsetsGeometry? padding,
    bool shrinkWrap = false,
