...
void main() {
  group("TreeView tests", () {
    testWidgets('Simple tree root view is properly rendered', (tester) async {
      await tester.pumpWidget(MockStatelessTreeView(tree: defaultTree));
    ...
    testWidgets(
      ...
      await tester.pumpWidget(MockStatelessTreeView(tree: treeToTest));
    ...
    testWidgets("TreeView is updated on updating the tree", (tester) async {
      await tester.pumpWidget(MockStatefulTreeView());
